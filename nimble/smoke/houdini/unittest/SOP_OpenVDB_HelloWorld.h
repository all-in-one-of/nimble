...
#ifndef __SOP_OpenVDB_HelloWorld_h__
#define __SOP_OpenVDB_HelloWorld_h__

#include <SOP/SOP_Node.h>

namespace HDK_Sample {
class SOP_OpenVDB_HelloWorld : public SOP_Node
{
public:
	     SOP_OpenVDB_HelloWorld(OP_Network *net, const char *name, OP_Operator *op);
    virtual ~SOP_OpenVDB_HelloWorld();
