...
newSopOperator(OP_OperatorTable *table)
{
    table->addOperator(new OP_Operator(
        "smoke_source",
        "Smoke Source",
        SOP_Smoke_Source::myConstructor,
        SOP_Smoke_Source::myTemplateList,
        1,
        1,
        NULL));
}
...
OP_Node *
SOP_Smoke_Source::myConstructor(OP_Network *net, const char *name, OP_Operator *op)
{
    return new SOP_Smoke_Source(net, name, op);
}

SOP_Smoke_Source::SOP_Smoke_Source(OP_Network *net, const char *name, OP_Operator *op)
...
SOP_Smoke_Source::~SOP_Smoke_Source() {}

bool
SOP_Smoke_Source::updateParmsFlags()
{
    bool changed;
...
OP_ERROR
SOP_Smoke_Source::cookInputGroups(OP_Context &context, int alone)
{
...
OP_ERROR
SOP_Smoke_Source::cookMyGuide1(OP_Context &context)
{
    const int divs = 5;
...
const char *
SOP_Smoke_Source::inputLabel(unsigned) const
{
